...
const schema = z.object({
  ...
  about_text: z.string().trim().max(2000).transform(sanitizeText).optional().or(z.literal("")),
  business_address: z.string().trim().max(300).transform(sanitizeText).optional().or(z.literal("")),
  ...
  facebook_url: z.string().trim().max(200).optional().or(z.literal("")),
  tiktok_url: z.string().trim().max(200).optional().or(z.literal("")),
  delivery_time: z.string().trim().max(120).transform(sanitizeText).optional().or(z.literal("")),
  return_days: z.string().trim().max(4).optional().or(z.literal("")),
  working_hours: z.string().trim().max(120).transform(sanitizeText).optional().or(z.literal("")),
  google_verification: z.string().trim().max(120).optional().or(z.literal("")),
